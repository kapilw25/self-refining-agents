...
The taxonomy of Figure~\ref{fig:taxonomy_main} foregrounds 77 systems chosen, by the placement
criteria of \S\ref{sec:method}, to populate a single analytical axis, weights versus skills, rather
than to enumerate the field. To situate those systems
