...
\input{figures/fig_corpus_collage}
...
by the explicit placement criteria of \S\ref{sec:method}, to populate a single analytical
taxonomy, and we exclude pure perception, navigation, and
...
\input{figures/fig_survey_timeline}
\FloatBarrier
