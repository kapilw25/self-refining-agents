...
\settopmatter{authorsperrow=3}      % pack authors horizontally (ACM still stacks in acmsmall)
\citestyle{acmauthoryear}           % [Author, Year] citations (matches the taxonomy figures)
