...
code-as-policy ladder (\S\ref{sec:code}). These fix the reviewer-relevant boundary cases: a
...
\label{sec:synthesis}
Table~\ref{tab:branch_limits} scores every family on six properties. No family scores well on
all of them, which is the tension the skill economy (\S\ref{sec:open}) inherits.
