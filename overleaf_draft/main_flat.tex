...
\end{figure}
 \begin{figure*}[tp]
\centering
\definecolor{pal1}{HTML}{C0392B}\definecolor{pal2}{HTML}{E67E22}\definecolor{pal3}{HTML}{B7950B}\definecolor{pal4}{HTML}{1E8449}\definecolor{pal5}{HTML}{7D3C98}\definecolor{pal6}{HTML}{C2185B}\definecolor{pal7}{HTML}{566573}\definecolor{pal8}{HTML}{6E2C00}\definecolor{pal9}{HTML}{7B241C}\definecolor{pal10}{HTML}{4A235A}\begin{tabular}{@{}c@{\hspace{7mm}}c@{}}
\begin{tikzpicture}[baseline]
  ...
  \foreach [count=\i] \l/\v in {16/2,17/7,18/10,19/13,20/16,21/21,22/30,23/64,24/53,25/9}{
    \fill[pal\i] ({\i*0.56-0.19},0) rectangle ({\i*0.56+0.19},{\v*0.0406});
...
\begin{tikzpicture}[baseline]
  ...
  \foreach [count=\i] \l/\v/\c in {sim/101/cat-vla, real/80/cat-code, game/26/cat-rew,
    ...
    \fill[pal\i] ({\i*0.72-0.26},0) rectangle ({\i*0.72+0.26},{\v*0.0257});
...
\begin{tikzpicture}[baseline]
  \foreach [count=\i] \l/\v in {IL/57, RL/56, LLM/39, {model-based}/27, {self-sup}/18,
    ...
    \fill[pal\i] (0,{-\i*0.44+3.4}) rectangle ({\v*0.052},{-\i*0.44+3.7});
...
\begin{tikzpicture}[baseline]
  \foreach [count=\i] \l/\v in {arm/87, {n/a}/64, mobile/24, multi/21, humanoid/12,
                                legged/9, hand/8}{
    \fill[pal\i] (0,{-\i*0.44+3.4}) rectangle ({\v*0.034},{-\i*0.44+3.7});
    \node[font=\scriptsize,left=2pt] at (0,{-\i*0.44+3.55}) {\l};
...
(Figure~\ref{fig:corpus_collage}), so their bars use a categorical palette that avoids the reserved pole colours (teal and blue).
